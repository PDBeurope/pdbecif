                        ...
                        if not isLoop:
                            ...
                            if ignoreCategories and category in ignoreCategories:
                                ...
                                if category in data_block:
                                    ...
                                    data_block.setdefault(category, OrderedDict({item: value if len(value) > 1 else value[0]})) # OrderedDict here preserves item order
                        else:
                            if ignoreCategories and category in ignoreCategories:
                                skipCategory = True
                            else:
                                data_block.setdefault(category, OrderedDict()) # OrderedDict here preserves item order
