...
class ItemTestCase(unittest.TestCase):
    ...
    def test_setValue(self):
        ...
        self.assertEqual(
            self.im.value, ["val_1", "val_2"], "Item value not set correctly"
        )
        self.assertEqual(
            self.im.type,
            ["DEFAULTSTRING", "DEFAULTSTRING"],
            "Item type not set correctly",
        )
    ...
    def test_getRawValue(self):
        ...
        self.assertEqual(
            self.im.getRawValue(), "_val_3", "T1: Item raw value not set correctly"
        )
        ...
        self.assertEqual(
            self.im.getRawValue(),
            ["_val_3", '"val_4" test 4\'', 7357.7357],
            "T3: Item raw value not set correctly",
        )

        self.im.setValue("7357\n73570")
        self.assertEqual(
            self.im.getRawValue(),
            ["_val_3", '"val_4" test 4\'', 7357.7357, "7357\n73570"],
    ...
    def test_non_ascii_quoted_properly(self):
        ...
        self.assertEqual(
            self.im.getFormattedValue(),
            '"α-alanine"',
            " getFormattedValue not handling non-ascii properly",
        )
    ...
    def test_getFormattedValue(self):
        ...
        self.assertEqual(
            self.im.getFormattedValue(),
            '"_val_3"',
            "T1: Item raw value not set correctly",
        )
    ...
    def test_remove(self):
        ...
        self.assertIsNotNone(
            self.ct.recycleBin.get("bar", None),
            "Item not moved to recycleBin as expected",
        )
        self.assertEqual(
            self.ct.recycleBin.get("bar"),
            self.im,
            "Item expected in recycleBin but not found",
        )
    ...
    def test_reset(self):
        ...
        self.im.reset()
        self.assertEqual(
            self.im.value, None, "Item values have not reset to None as expected"
        )
        self.im.setValue("val_1")
        self.im.setValue("val_2")
        self.im.reset()
        self.assertEqual(
            self.im.value,
            [None, None],
            "Item values have not reset to None as expected",
        )
