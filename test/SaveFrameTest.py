...
#        self.foo = None
    ...
    def test_setCategory(self):
        ...
        self.assertEqual(cat_2, self.sf.getCategory("_bar"), "Category not set by registration using object")
    ...
    def test_getCategory(self):
        ...
        self.assertIsInstance(self.sf.getCategory("_foo"), Category, "Get category did not return Category")
        self.assertEqual(cat, self.sf.getCategory("_foo"), "Category name not set correctly")
    ...
    def test_removeChildBadRef(self):
        msg = "SaveFrame.removeChild"
        self.sf.setCategory("foo")
        self.assertFalse(self.sf.removeChild("FAIL"), msg+" did not return expected False" )
